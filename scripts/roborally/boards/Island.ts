import {
  ...
  setCell,
  setWall,
} from "common/roborally/model/Board"
import {
  getConveyor,
  getGear,
  getHole,
...
board = addLaser(board, getPos(0, 2), Direction.EAST, 1)
board = setWall(board, getPos(0, 4), Direction.WEST)
board = addLaser(board, getPos(0, 4), Direction.EAST, 1)
board = setWall(board, getPos(0, 7), Direction.WEST)
board = addLaser(board, getPos(0, 7), Direction.EAST, 1)
board = setWall(board, getPos(0, 9), Direction.WEST)
board = addLaser(board, getPos(0, 9), Direction.EAST, 1)
...
board = addLaser(board, getPos(2, 0), Direction.SOUTH, 1)
...
board = addLaser(board, getPos(2, 11), Direction.NORTH, 1)
...
board = addLaser(board, getPos(4, 0), Direction.SOUTH, 1)
board = setCell(board, getPos(4, 2), getConveyor(Direction.EAST))
board = setCell(board, getPos(4, 3), getConveyor(Direction.WEST, true))
board = setCell(board, getPos(4, 5), getConveyor(Direction.WEST))
...
board = addLaser(board, getPos(4, 11), Direction.NORTH, 1)
...
board = addLaser(board, getPos(7, 0), Direction.SOUTH, 1)
...
board = setCell(board, getPos(7, 6), getConveyor(Direction.EAST))
board = setCell(board, getPos(7, 8), getConveyor(Direction.EAST, true))
board = setCell(board, getPos(7, 9), getConveyor(Direction.WEST))
board = setWall(board, getPos(7, 11), Direction.SOUTH)
board = addLaser(board, getPos(7, 11), Direction.NORTH, 1)
...
board = addLaser(board, getPos(9, 0), Direction.SOUTH, 1)
...
board = addLaser(board, getPos(9, 11), Direction.NORTH, 1)
...
board = addLaser(board, getPos(11, 2), Direction.WEST, 1)
board = setWall(board, getPos(11, 4), Direction.EAST)
board = addLaser(board, getPos(11, 4), Direction.WEST, 1)
board = setWall(board, getPos(11, 7), Direction.EAST)
board = addLaser(board, getPos(11, 7), Direction.WEST, 1)
board = setWall(board, getPos(11, 9), Direction.EAST)
board = addLaser(board, getPos(11, 9), Direction.WEST, 1)
